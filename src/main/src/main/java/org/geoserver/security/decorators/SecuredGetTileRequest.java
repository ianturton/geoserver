...
/**
 * Wraps a GetTile request enforcing map limits for each of the layers
 * @author Andrea Aime - GeoSolutions
 */
public class SecuredGetTileRequest implements GetTileRequest {
    static final Logger LOGGER = Logging.getLogger(SecuredGetTileRequest.class);
    
    GetTileRequest delegate;
    ...
    public SecuredGetTileRequest(GetTileRequest delegate) {
    ...
    public String buildCQLFilter() {
        ...
        for(int i = 0; i < layers.size(); i++) {
            ...
            if(layer instanceof SecuredWMSLayer) {
                SecuredWMTSLayer secured = (SecuredWMTSLayer) layer;
                ...
                if(policy.getLimits() instanceof WMTSAccessLimits) {
                    WMTSAccessLimits limits = (WMTSAccessLimits) policy.getLimits();
                    ...
                    if(limits.getRasterFilter() != null) {
                         ...
                         */
                        LOGGER.severe("Sorry, raster filters for cascaded wmts layers " +
    ...
    public void setCRS(CoordinateReferenceSystem coordinateReferenceSystem) {
       delegate.setCRS(coordinateReferenceSystem);
